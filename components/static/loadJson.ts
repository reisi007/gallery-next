...
export type ImageDetails = { [url: string]: ImageDetail };
export type ImageDetail = { filename: string, categories: Array<NameWithUrl>, tags: Array<NameWithUrl> };
export type NameWithUrl = { name: string, url: string };
